...
@kwdef mutable struct RacetrackAnalysisSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :RacetrackAnalysis
  ...
  var"model"::Union{Nothing, System} = Test4.RacetrackAssembly(; name=:RacetrackAssembly)
end

function DyadInterface.run_analysis(spec::RacetrackAnalysisSpec)
...
RacetrackAnalysis(;kwargs...) = run_analysis(RacetrackAnalysisSpec(;kwargs...))
export RacetrackAnalysis, RacetrackAnalysisSpec
