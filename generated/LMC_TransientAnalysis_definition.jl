...
@kwdef mutable struct LMC_TransientAnalysisSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :LMC_TransientAnalysis
  ...
  var"model"::Union{Nothing, System} = Test4.LMC_Configuration(; name=:LMC_Configuration)
end

function DyadInterface.run_analysis(spec::LMC_TransientAnalysisSpec)
...
LMC_TransientAnalysis(;kwargs...) = run_analysis(LMC_TransientAnalysisSpec(;kwargs...))
export LMC_TransientAnalysis, LMC_TransientAnalysisSpec
