# ============================================================================
#  Figure 1 — Coil Geometry (top view + side view)
#  Shows 42 coils as projected ellipses, not dots.
#
#  Run:  julia --project=. scripts/plot_geometry.jl
# ============================================================================

include(joinpath(@__DIR__, "lmc_field_utils.jl"))
using Plots; gr()

cs = make_coils()   # baseline parameters

# ── Helper: draw one coil as an ellipse projected onto 2-D ─────────────────
...
outpath = joinpath(@__DIR__, "..", "lmc_geometry.png")
savefig(fig, outpath)
